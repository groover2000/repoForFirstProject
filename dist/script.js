...
window.addEventListener("DOMContentLoaded", () => {
  ...
  Object(_modules_timer__WEBPACK_IMPORTED_MODULE_5__["default"])('#timer', 'Jan 29, 2022');
...
const modal = () => {
  ...
  function showModal(openBtn, popup, closeBtn) {
    let closeOverlay = arguments.length > 3 && arguments[3] !== undefined ? arguments[3] : true;
  ...
  showModal('.phone_link', '.popup', ' .popup .popup_close'); // showIntervalModal('.popup_engineer', '.popup_engineer .popup_close' );
...
"use strict";
__webpack_require__.r(__webpack_exports__);
const tabs = function (mainSelector, tabSelector, contentSelector, activeSelector) {
